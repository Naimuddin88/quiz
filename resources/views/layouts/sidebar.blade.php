...
<div class="sidenav-header">
  ...
  <a class="navbar-brand m-2" href="{{ Auth::user()->role == 'admin' ? route('admin.dashboard') : route('dashboard') }}" target="_blank">
...
<div class="collapse navbar-collapse w-auto max-height-vh-100 h-100 ps ps--active-y" id="sidenav-collapse-main" style="overflow-y: auto;">
  <ul class="navbar-nav">
      @auth
          ...
          <li class="nav-item">
              <a class="nav-link {{ Request::is('questions*') ? 'active' : '' }}" href="#" id="navbarDropdown1" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                      <title>office</title>
                      <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
